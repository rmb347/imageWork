...
public class CSCoTraining_tT2 {
	...
	public static void testCoTraining(List<String> testUrls, Instances train_view1, Instances valid_view1, 
...
*/			
		...
		if(testOpFile.exists())
		{
			PrintWriter writer = new PrintWriter(testOpFile);
			writer.print("");
			writer.close();
		}
		FileWriter fwop = new FileWriter(testOpFile, true);
		String []  opList = new String[test_view1.numInstances()];
		//adding url
		
		
		for(int j = 0;j < test_view1.numInstances(); j++){
			opList[j] = new String(testUrls.get(j) + ", ");
		}
		
		//adding class
		for(int j = 0;j < test_view1.numInstances(); j++){
			Instance testCrt = test_view1.instance(j);
			String cls = testCrt.stringValue(testCrt.classAttribute());
			opList[j] += new String(cls + ", ");
		}
		for(int j = 0;j < test_view1.numInstances(); j++){
...
public static void run(int trainsize) throws Exception {
		
        System.out.print(new Date(System.currentTimeMillis()) + "\t");
        System.out.print(new Time(System.currentTimeMillis()) + "\n");
		
		String path = "/Users/Aurnob/Downloads/images/src/data/sample/rahul/september9/10000/rgb/rgbtest/";
		...
		String m_Train1 = path + "/train1.arff";
		String m_Valid1 = path + "/valid1.arff";
		String m_Test1 = path + "/test1.arff";
		
		String m_Train2 = path + "/train2.arff";
		String m_Valid2 = path + "/valid2.arff";
		String m_Test2 = path + "/test2.arff";
		
		
		String m_Unlabeled1 = path + "/unlabeled1.arff";
		String m_Unlabeled2 = path + "/unlabeled2.arff";
		
	//	String output = path + "/output/ct_nbm_rf.txt";
		String output = path + cType1 + "_"+ cType2+ "_" + "trainingSize_" + trainsize + "_" + no_iter+ "_"+ sample_size+ ".txt";
...
//	    valid_view2.setClassIndex(valid_view2.numAttributes()-1);
	    ...
	    String fName = ImageTags.location;
	    File file = new File(fName+"10000_unique_metadata");
	    List<String> list = ImageTags.getURLList(file);
	    int trainSize = train_view1.numInstances();
	    int testSize = test_view1.numInstances();
	    int unlabeledSize = unlabeled_view1.numInstances();
//	    List<String> trainList = list.subList(0, trainSize);
//	    List<String> unlabeledList = list.subList(trainSize , trainSize+unlabeledSize);
//	    List<String> testList = list.subList(trainSize+unlabeledSize , trainSize+unlabeledSize+testSize);
//	    
//	    List<String> testList = new ArrayList<String>();
//		CSCoTraining_tT2.testCoTraining(testList, train_view1, null, train_view2, null,
//				unlabeled_view1, unlabeled_view2, test_view1, test_view2, seed,
//				sample_size, no_iter, cType1, cType2, output);

		String opPrefix = path + cType1 + "_"+ cType2+ "_" + no_iter+ "_"+ sample_size;
		cotraining.copy.CSCoTraining_tT2.testCoTraining(train_view1, null, train_view2, null,
				unlabeled_view1, unlabeled_view2, test_view1, test_view2, seed,
				sample_size, no_iter, cType1, cType2, output+"_testCoTraining_new");
		
		
//		CSCoTraining_tT2.testCoTrainingBlumMitchellNoRatio (train_view1, null, train_view2, null,
//				unlabeled_view1, unlabeled_view2, test_view1, test_view2, seed,
//				sample_size, no_iter, cType1, cType2, output+"_testCoTrainingBlumMitchellNoRatio");
//		
//		CSCoTraining_tT2.testCoTrainingBlumMitchellNoRatio2 (train_view1, null, train_view2, null,
//				unlabeled_view1, unlabeled_view2, test_view1, test_view2, seed,
//				sample_size, no_iter, cType1, cType2, output+"_testCoTrainingBlumMitchellNoRatio2");
//		
//		CSCoTraining_tT2.testCoTrainingBlumMitchellNoRatio3 (train_view1, null, train_view2, null,
//				unlabeled_view1, unlabeled_view2, test_view1, test_view2, seed,
//				sample_size, no_iter, cType1, cType2, output+"_testCoTrainingBlumMitchellNoRatio3");
//		
//		CSCoTraining_tT2.testCoTrainingBlumMitchellNoRatio2_4 (train_view1, null, train_view2, null,
//				unlabeled_view1, unlabeled_view2, test_view1, test_view2, seed,
//				cType1, cType2, output+"_testCoTrainingBlumMitchellNoRatio");
		
//		String outputbsh = path + cType1 + "_"+ cType2+ "_" + no_iter+ "_"+ sample_size+"_baselinehigh.txt";
//		CSCoTraining_tT2.baseline_high(train_view1, test_view1, train_view2, test_view2, cType1, cType2, outputbsh);
		String outputbsl = output+"_baselinelow.txt";
		String outputbsh = output+"_baselinehigh.txt";
		//CSCoTraining_tT2.baseline_high(train_view1, test_view1, train_view2, test_view2, cType1, cType2, outputbsh);
		//CSCoTraining_tT2.baseline_low(train_view1, test_view1, train_view2, test_view2, cType1, cType2, sizeF_l, outputbsl);
		//CSCoTraining_tT2.baseline_low(train_view1, test_view1, train_view2, test_view2, cType1, cType2, outputbs);
		/*
		 * CSCoTraining_tT2.testCoTraining2(train_view1, valid_view1,
		 * train_view2, valid_view2, unlabeled_view1, unlabeled_view2,
		 * test_view1, test_view2, seed, sample_size, no_iter, cType1, cType2,
		 * output);
		 */
		/*
		 * CSCoTraining_tT2.testCoTrainingBlumMitchellNoRatio(train_view1,
		 * valid_view1, train_view2, valid_view2, unlabeled_view1,
		 * unlabeled_view2, test_view1, test_view2, seed, sample_size, no_iter,
		 * cType1, cType2, output);
	...
	public static void runParts(int trainsize) throws Exception {
		
        System.out.print(new Date(System.currentTimeMillis()) + "\t");
        System.out.print(new Time(System.currentTimeMillis()) + "\n");
		
		String path = "/Users/Aurnob/Downloads/images/src/data/sample/rahul/september9/10000/properTest/var_unlab/";
	...
	//	String output = path + "/output/ct_nbm_rf.txt";
		String output = path + cType1 + "_"+ cType2+ "_" + "trainingSize_" + trainsize + "_" + no_iter+ "_"+ sample_size;
	    ...
	    source = null;
	    source = new DataSource(m_Unlabeled1);
	    Instances unlabeled1 = source.getDataSet();
	    Instances unlabeled_view1 = new Instances(unlabeled1, 0, trainsize);
	    unlabeled_view1.setClassIndex(unlabeled_view1.numAttributes()-1);
...
//	    valid_view1.setClassIndex(valid_view1.numAttributes()-1);
		...
		source = null;
	    source = new DataSource(m_Train2);
	    Instances train2 = source.getDataSet();
	    Instances train_view2= new Instances(train2, 0, trainsize);
	    train_view2.setClassIndex(train_view2.numAttributes()-1);
		
	    System.out.println("\nLoading unlabeled_view2!");
	    source = null;
	    source = new DataSource(m_Unlabeled2);
	    Instances unlabeled2 = source.getDataSet();
	    Instances unlabeled_view2 = new Instances(unlabeled2, 0, trainsize);
	    unlabeled_view2.setClassIndex(unlabeled_view2.numAttributes()-1);
...
//				sample_size, no_iter, cType1, cType2, output);
		...
		cotraining.copy.CSCoTraining_tT2.testCoTraining(train_view1, null, train_view2, null,
				unlabeled_view1, unlabeled_view2, test_view1, test_view2, seed,
				sample_size, no_iter, cType1, cType2, output+"_unlabeledSize_" + trainsize);
